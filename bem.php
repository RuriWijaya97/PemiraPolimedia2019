<?php 
$level = $_SESSION['tbl_user']['status_bem'];
...
<div class="block-header">
   <h2>Calon Ketua Dan Wakil Ketua BEM</h2>
</div>
...
<div class="row clearfix">
	<?php $no = 1; ?>
		...
		$ambil=$conn->query("SELECT * FROM tbl_calon WHERE  pilihan_ormawa = 'BEM' ORDER BY id_calon"); ?>
    	...
    	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
     	<div class="card">
            ...
            <div class="body center">
		    	<img src="img/fotokandidat/<?php echo $pecah['foto']; ?>" width="200" height="200" alt="User" class="circle" /> <!-- <?php echo $pecah['foto']; ?> -->
		    <hr>
		    <h4>
            ...
            <h4>
            	<?php echo $pecah['nama_psngn_calon']; ?>
            </h4>
            <?php 
            $tes = $_SESSION['tbl_user']['id_user']; 
            ?>
            	<a href="?halaman=pilih-calon-bem&id=<?php echo $pecah['id_calon'].'&ni='.$tes ?>" class="btn btn-block btn-lg btn-primary waves-effect" onclick="return confirm('Kamu Yakin Ingin Memilih Kandidat Nomor Urut <?php echo $no?>?');">PILIH</a>
